...
# ──────────────────────────────────────────────────────────────
# 電池參數（模擬 4 組模組並聯容量，依據 8Feb2025 規劃書）
# 容量: 1.4792A × 2hr × 4組 = 11833.6 mAh, 16.57Wh × 4 = 66.28 Wh
# 功率: P302 硬體極限 20mA × 8.5V = 170mW（不可更改）
# ──────────────────────────────────────────────────────────────
BATTERY_N_MODULES       = 4              # 並聯模組數（容量計算用）
...
BATTERY_CHARGE_I_MA     = 20.0           # mA（P302 硬體額定電流，不可更改）
BATTERY_CAPACITY_WH     = 66.28          # 4組總儲能 (Wh)
BATTERY_CAPACITY_KWH    = BATTERY_CAPACITY_WH / 1000   # ≈ 0.06628 kWh
BATTERY_POWER_W         = BATTERY_CHARGE_I_MA * BATTERY_CHARGE_V / 1000  # 0.17 W (170 mW)
BATTERY_POWER_KW        = BATTERY_POWER_W / 1000        # ≈ 0.00017 kW
